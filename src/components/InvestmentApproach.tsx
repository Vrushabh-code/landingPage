      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          {investmentTiers.map((tier, index) => (
            <FadeIn key={index} delay={150 + index * 150} direction={index % 2 === 0 ? 'left' : 'right'} scale={true}>
              <Card className="border-0 shadow-sm h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
