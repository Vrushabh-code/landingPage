      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {founderTypes.map((type, index) => (
            <FadeIn key={index} delay={150 + index * 100} direction="up" scale={true}>
              <Card className="border-0 shadow-sm h-full hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
